...
def run_program(opcode):
    ...
    while i < len(opcode):
        ...
        if code == 1:
            ...
            opcode[opcode[i+1]] = int(input())
            i += 2

        elif code == 4:
            print(get_val(i+1, code_C))
            i += 2
