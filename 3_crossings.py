# Find where the two lines cross each other, closest to the origin point.
...
def find_crossing(line_1, line_2):
    print("build path 1...")
    path_1 = build_path(line_1)
    print("len path 1: ", len(path_1), "building path 2...")
    path_2 = build_path(line_2)
    path_2_set = set(path_2)
    print("len path 2: ", len(path_2))

    crossings = []

    for step_1 in path_1:
        if step_1 in path_2_set:
            crossings.append((abs(step_1[0]) + abs(step_1[1]), step_1))
    ...
    for c in crossings:
        i1 = path_1.index(c[1])
        i2 = path_2.index(c[1])
        path_lens.append(i1+i2)

    print(sorted(path_lens))

    return crossings


line_1 = "R75,D30,R83,U83,L12,D49,R71,U7,L72"
line_2 = "U62,R66,U55,R34,D71,R55,D58,R83"
distance = 159

crossings = find_crossing(line_1, line_2)

assert (crossings[1][0] == distance)


line_1 = "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51"
line_2 = "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
distance = 135
